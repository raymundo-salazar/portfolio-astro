export default {
	...
	hero: {
		text: "Fullstack JS Developer & UI/UX Designer con más de {{YEARS}} años de experiencia en desarrollo web y móvil. Especializado en liderazgo técnico, TypeScript, React, React Native y Node.js.",
		myWork: "Mi Trabajo",
	...
	about: {
		title: "Acerca de mí",
		description:
			"Soy un Fullstack JS Developer & UI/UX Designer con más de {{YEARS}} años de experiencia en desarrollo web y móvil. He liderado equipos de desarrollo y supervisado la creación de aplicaciones escalables y de alto rendimiento, con enfoque en arquitectura de software y experiencia de usuario.",
		description2:
			"Mi trayectoria incluye el liderazgo de equipos de desarrollo, implementación de pipelines CI/CD, y la creación de sistemas de diseño cohesivos. He trabajado en proyectos gubernamentales y del sector privado, siempre enfocándome en la calidad del código, testing automatizado y experiencias de usuario intuitivas.",
		cards: {
			lead: {
				title: "Desarrollador Líder",
	...
	timeline: {
		...
		description:
			"Más de {{YEARS}} años de trayectoria en desarrollo web, móvil y liderazgo técnico",
		types: {
		...
		companies: "Empresas",
		productionApps: "Apps en producción",
		leadershipRoles: "Roles de liderazgo",
		experiences: {
			vittiLeader: {
				description:
					"Liderazgo técnico del equipo de desarrollo, definiendo arquitectura, estándares y mejores prácticas para las aplicaciones internas de logística, transporte y exportación. Coordinación de esfuerzos entre desarrollo, infraestructura y operaciones.",
				achievements: [
					"Dirección y mentoría del equipo de desarrollo",
					"Definición de lineamientos técnicos y arquitectura base",
					"Implementación de pipelines CI/CD en Azure DevOps",
					"Optimización de sistemas internos de logística y facturación",
				],
			},

			vittiSupply: {
				description:
					"Desarrollo fullstack de plataformas para gestión logística, trazabilidad, operaciones aduanales y procesos de supply chain. Participación en la optimización de flujos internos y automatización de procesos clave.",
				achievements: [
					"Desarrollo y mantenimiento de módulos críticos de logística",
					"Integración de servicios para exportación, importación y tracking",
					"Mejoras de rendimiento en procesos de facturación y aduanas",
					"Participación en la automatización de despliegues y pruebas",
				],
			},
	...
	projects: {
		...
		description:
			"Una selección de proyectos que demuestran mis habilidades en desarrollo web, móvil y diseño UX/UI.",
		...
		modal: {
			...
			seeOnPlayStore: "Ver en Play Store",
			seeOnAppStore: "Ver en App Store",
